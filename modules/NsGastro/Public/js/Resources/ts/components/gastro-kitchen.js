...
export default {
    ...
    mounted() {
        ...
        if (ns.date.timeZone === '') {
            return nsSnackBar.error(this.localization('The timezone is not defined. Please consider configuring the timezone on the general settings', 'NsGastro'), this.localization('Ok', 'NsGastro'), { duration: 10000 }).subscribe();
        }
...
//# sourceMappingURL=gastro-kitchen.js.map