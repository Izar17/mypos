export default {
    ...
    computed: {
        title() {
            return this.popup.params.title || this.localization('Untitled Popup', 'NsGastro');
        }
    },
    mounted() {
        this.fields = this.validation.createFields(this.popup.params.fields);
        this.popupCloser();
    },
    methods: {
        localization: __m,
...
//# sourceMappingURL=gastro-kitchen-settings.js.map