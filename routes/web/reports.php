...
// lcabornay
Route::get( '/reports/xreading', [ ReportsController::class, 'xReading' ] )->name( ns()->routeName( 'ns.dashboard.report.xreading' ) );
Route::get( '/reports/zreading', [ ReportsController::class, 'zReading' ] )->name( ns()->routeName( 'ns.dashboard.report.zreading' ) );
