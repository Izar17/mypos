...
//lcabornay
    ...
    {
        return View::make( 'pages.dashboard.reports.zreading-report', [
            'title' => __( 'Z Reading Report' ),
            'description' => __( 'Provides a report for Z reading.' ),
        ] );
    }

    public function xReading()
    {
        return View::make( 'pages.dashboard.reports.xreading-report', [
            'title' => __( 'X Reading Report' ),
            'description' => __( 'Provides a report for X reading.' ),
        ] );
    }
 ...
 // lcabornay
    public function getXzReadingReport( Request $request )
    {
        return $this->reportService
            ->getXzReadingReport(
                $request->input( 'startDate' ),
