...
const nsXreadingReport             =   defineAsyncComponent( () => import( './pages/dashboard/reports/ns-xreading-report.vue' ) ); // lcabornay
const nsZreadingReport             =   defineAsyncComponent( () => import( './pages/dashboard/reports/ns-zreading-report.vue' ) ); // lcabornay
...
const allComponents    =   Object.assign({
    ...
    nsNotifications,
    nsSaleReport,
    nsXreadingReport, // lcabornay
    nsZreadingReport, // lcabornay
    nsSoldStockReport,
    nsProfitReport,
